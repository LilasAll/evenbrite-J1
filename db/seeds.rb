...
8.times do 
	User.create!(email: "user#{rand(1..100)}@yopmail.com",password: Faker::Lorem.paragraph_by_chars(number: 8, supplemental: false),description: Faker::Lorem.paragraph_by_chars(number: 100, supplemental: false),first_name: Faker::Name.first_name,last_name: Faker::Name.last_name)
end
puts "User created"
